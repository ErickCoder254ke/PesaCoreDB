...
class Tokenizer:
    ...
    TOKEN_PATTERNS = [
        ...
        ('KEYWORD', r'\b(?:CREATE|DROP|USE|SHOW|DESCRIBE|DESC|TABLE|TABLES|DATABASE|DATABASES|INSERT|INTO|VALUES|SELECT|FROM|WHERE|UPDATE|SET|DELETE|INNER|JOIN|ON|PRIMARY|KEY|UNIQUE|REFERENCES|INT|FLOAT|REAL|DOUBLE|DECIMAL|STRING|BOOL|TRUE|FALSE|NULL|AND|OR|NOT|ORDER|BY|ASC|DESC|LIKE|IN|BETWEEN|IS|GROUP|HAVING|COUNT|SUM|AVG|MIN|MAX|DISTINCT|LIMIT|OFFSET|AS)\b'),
